 ...
 <script src="<?php $base_url; ?>assets/js/plugins/jeditable/jquery.jeditable.js"></script>
    ...
    <!-- Data Tables -->
    <script src="<?php $base_url; ?>assets/js/plugins/dataTables/jquery.dataTables.js"></script>
