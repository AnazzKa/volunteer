                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <form role="form" id="form_search" method="post">
                                    ...
                                    <?php if (!empty($medical_form_submission)) { ?>
                                            ...
                                            <div class="table-responsive" id="dvContents">
                                                <table class="table dataTables-example" >
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $cnt = 0;
                                                        foreach ($medical_form_submission as $row1) {
                                                            $cnt++;
                                                            $tme = $row1->submit_time;
                                                            $data['medical_form_submission_ne'] = $this->medical_form_submission_model->get_all(1, $tme);

                                                            $date = date('r', $tme);
                                                            foreach ($data['medical_form_submission_ne'] as $row) {
                                                                ?>
                                                                <?php if ($row->field_order == 0) { ?>
                                                                    ...
                                                                    <?php } ?>
                                                                    <?php if ($row->field_name == 'patientName') { ?>
                                                                        <td><?php echo $row->field_value; ?></td>
                                                                    <?php } ?>
                                                                    <?php if ($row->field_name == 'mobileNumber') { ?>
                                                                        <td><?php echo $row->field_value; ?></td>
